...
Versiune: **0.4.1** · Home Assistant: **2025.1+** · România
...
> hash-ul commit-ului, nu `0.4.1`. Integrarea funcționează normal; un tag
> `v0.4.1` ar activa doar afișarea versiunii și notificările de update.
